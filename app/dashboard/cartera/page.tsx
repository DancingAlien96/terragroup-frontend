...
export default function CarteraVencidaPage() {
  ...
  return (
    <div className="p-4 sm:p-6 bg-[#f9fafb] min-h-full">
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-[#1a1a1a]">Cartera Vencida</h1>
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100 flex-wrap">
          ...
          <div className="relative w-full sm:w-auto sm:ml-auto">
            ...
            <input type="text" placeholder="Buscar cliente o lote..." value={busqueda}
              ...
              className="pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#d4a843] focus:border-transparent w-full sm:w-60" />
          </div>
        </div>
